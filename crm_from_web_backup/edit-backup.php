                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="agent" required>
                                        <?php $agent_single = User::find_by_id($property->agent); ?>
                                        <option value="<?php echo $agent_single->id;?>"><?php echo $agent_single->first_name.' '.$agent_single->last_name;?></option>
                                        <option disabled role=separator>______________________</option>
                                        <?php 
