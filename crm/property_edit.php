                    ...
                    <div class="col-lg-12">
                          ...
                          <div class="panel-body grey">
                            <?php
                              ...
                              <?php foreach($property_images as $property_image) :?>
                                <div class="col-md-4">
                                    <img class="img-responsive thumbnail" src="<?php echo $property_image->filename; ?>" alt="">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="font">
                            ...
                            <div>
                              ...
                              <div id="maps"></div>
                              <input type="text" name="lat" id="lat" value="<?php echo $property->lat;?>" >
                              <input type="text" name="lng" id="lng" value="<?php echo $property->lng;?>" >
                            </div><br>
                          ...
                          <?php if($user_session->struc==2):?>
                            <div class="panel panel-primary">
                              ...
                              <div class="panel-body">
                                ...
                                <label class="radio-inline"><input type="radio" name="optradio" value="1" <?php if($property->status==1){echo 'checked="checked"';} ?>>Publish</label>
                              ...
                              <div class="panel-body">
                                  <table class="table table-borderless">
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <th>Land Size *</th>
                                        <td><input type="text" name="land_size" class="form-control" value="<?php echo $property->land_size;?>"></td>
                                      </tr>
                                      <tr>
                                        <th>House Size</th>
                                        <td><input type="text" name="house_size" class="form-control" value="<?php echo $property->house_size;?>"></td>
                                      </tr>
                                      <tr>
                                        <th>Bed Room</th>
