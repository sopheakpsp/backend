$(document).ready(function() {
    ...
    function map_initialize() {
        ...
        google.maps.event.addListener(map, 'rightclick', function(event) {
            ...
            var EditForm = '<p><div class="marker-edit">' +
                ...
                '<label type="pType"><span>Type: </span><select name="pType" class="save-type"><option value="1">Subject Property</option><option value="2">Surrounding</option></select>'+
                '</form>' +
                '</div></p>';

            //Drop a new Marker with our Edit Form
            create_marker(event.latLng, 'New Marker', EditForm, true, true, true, "icons/maps.png");
        });
    ...
    function remove_marker(Marker) {
        ...
        if (Marker.getDraggable()) {
            ...
            $.ajax({
                type: "POST",
                url: "include/map_process_listpage.php",
                data: myData,
