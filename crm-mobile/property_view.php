                             ...
                             ?>
                                ...
                                <?php
                                    ...
                                    if($property->status == 1){
                                      echo "<div class='label label-primary'>published</div>";
                                    }
                                    elseif ($property->status == 2) {
                                      echo "<div class='label label-primary'>available</div>";
                                    }
                                    elseif ($property->status == 3){
                                      echo "<div class='label label-danger'>rending</div>";
                                    }
                                    elseif ($property->status == 4){
                                      echo "<div class='label label-danger'>sold</div>";
                                    }
                                    else{
                                      echo "<div class='label label-danger'>deleted</div>";
                                    }
                                ?>
                                </small>
                            </h2>
                            ...
                            <div class="font">
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                      ...
                                      <p><?php echo $property->user_note; ?></p>
                                    </div>
                              ...
                              <div class="panel-body">
                                  <table class="table table-borderless">
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <th>Land (WL)):</th>
                                        <td><?php echo $property->l_width. ' X ' .$property->l_length; ?></td>
                                      </tr>
                                      <tr>
                                        <th>Land Total:</th>
                                        <td><?php echo $property->land_size; ?> SQM</td>
                                      </tr>
                                      <tr>
                                        <th>House (WL):</th>
                                        <td><?php echo $property->h_width. ' X ' .$property->h_length; ?></td>
                                      </tr>
                                      <tr>
                                        <th>House Total:</th>
                                        <td><?php echo $property->house_size; ?> SQM</td>
                                      </tr>
                                      <tr>
                                        <th>Bed Room:</th>
