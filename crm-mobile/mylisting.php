...
if(empty($_GET['by'])){
	$sql = "SELECT * FROM property WHERE status <> 5 AND agent = {$user_id} ORDER BY id DESC LIMIT {$item_per_page} OFFSET {$paginate->offset()}";
}else{
	$sql = "SELECT * FROM property WHERE status = {$by} AND agent = {$user_id} ORDER BY id DESC LIMIT {$item_per_page} OFFSET {$paginate->offset()}";
}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-header">
                            My Property Listing <br>
                            <small>
                            	<!-- <a href="mylisting.php"><b>Total: <?php echo Property::count_all_by_agent($user_id); ?></b></a> |  -->
                            	<a href="mylisting.php?by=2">Available: <?php echo $avail = Property::count_by_agent($user_id, 2); ?></a> | 
                            	<a href="mylisting.php?by=1">Publish: <?php echo $avail = Property::count_by_agent($user_id, 1); ?></a> | 
                            	<a href="mylisting.php?by=4">Sold: <?php echo $avail = Property::count_by_agent($user_id, 4); ?></a> |
                            	<a href="mylisting.php?by=3">Rent: <?php echo $avail = Property::count_by_agent($user_id, 3); ?></a> |
                            	<a href="mylisting.php?by=5">Deleted: <?php echo $avail = Property::count_by_agent($user_id, 5); ?></a>
	                        </small>
						        ...
						        <?php foreach ($properties as $property) : ?>
						        	...
						        	<div class="font">
				                        <div class="thumbnail">
				                        	...
				                        	<?php $photo_preview = Property_image::find_by_ref_id($property->id); ?>
				                        	<div style="height:160px; background:url(<?php echo !empty($photo_preview->filename) ? $photo_preview->filename : 'img/nopropertyfound.png';?>) no-repeat center; background-size: auto 120%;"></div>
				                            ...
				                            <div class="pull-right">
				                                ...
				                                <?php 
				                                    ...
				                                    echo $addressLine;
				                                 ?>
				                                <div><b>Listing Date: </b><?php echo $property->listed_date; ?></div>
				                                <div><b>Agent: </b>
					                                <?php 
				                                ...
				                                <?php if($user_session->id==$property->agent OR $user_session->id==1 ): ?>
