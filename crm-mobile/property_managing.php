...
if(empty($_GET['by'])){
	$sql = "SELECT * FROM property WHERE status <> 5 ORDER BY id DESC LIMIT {$item_per_page} OFFSET {$paginate->offset()}";
}else{
	$sql = "SELECT * FROM property WHERE status = {$by} ORDER BY id DESC LIMIT {$item_per_page} OFFSET {$paginate->offset()}";
}
                    ...
                    <div class="col-md-12">
                        <h2 class="page-header">
                            ...
                            <small>
                            	...
                            	<a href="property_managing.php?by=3">Rend: <?php echo $avail = Property::count_by_status(3); ?></a> |
