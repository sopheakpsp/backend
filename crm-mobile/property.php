                        ...
                        <form action="property.php" method="post" enctype="multipart/form-data" class="font">
                          ...
                          <div class="col-md-8">
                            ...
                            <div>
                              ...
                              <input type="text" name="lat" id="lat" class="no-border" value="<?php echo !empty($getlat)?$getlat:"";?>">
                              <input type="text" name="lng" id="lng" class="no-border" value="<?php echo !empty($getlng)?$getlng:"";?>">
                            </div><br>
                            ...
                            <div class="form-group">
                              ...
                              <textarea class="form-control" name="description" class="responsive-textarea"></textarea>
                            </div>
                              ...
                              <div class="panel-body">
                                  <table class="table table-borderless">
                                    <tbody>
                                      ...
                                      <tr>
                                        <th>L. Width</th>
                                        <td><input type="number" name="l_width" class="form-control" step="0.01" id="l_width" onkeyup="landTotal();"></td>
                                      </tr>
                                      <tr>
                                        <th>L. Length</th>
                                        <td><input type="number" name="l_length" class="form-control" step="0.01" id="l_length" onkeyup="landTotal();"></td>
                                      </tr>
                                      <tr>
                                        <th>Land Size</th>
                                        <td><input type="number" name="land_size" class="form-control" step="0.01" id="land_size"></td>
                                      </tr>
                                      <tr>
                                        <th>B. Width</th>
                                        <td><input type="number" name="h_width" class="form-control" step="0.01" id="h_width" onkeyup="houseTotal()"></td>
                                      </tr>
                                      <tr>
                                        <th>B. Length</th>
                                        <td><input type="number" name="h_length" class="form-control" step="0.01" id="h_length" onkeyup="houseTotal()"></td>
                                      </tr>
                                      <tr>
                                        <th>Building Size</th>
                                        <td><input type="number" name="house_size" class="form-control" step="0.01" id="house_size"></td>
                                      </tr>
                                      <tr>
                                        <th>Bed Room</th>
