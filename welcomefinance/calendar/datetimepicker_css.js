  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (winCal == undefined) {
     ...
     // add javascript function to the span cal
       ...
       with (span.style) {position = "absolute"; left = (xpos-205)+'px'; top = (ypos+9)+'px'; width = CalWidth+'px'; border = "solid 2pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 100;}
	  ...
	  if(bNewCal==true){
	     winCal.style.left = (xpos-205)+'px';
	     winCal.style.top = (ypos+9)+'px';
	   }
	}
