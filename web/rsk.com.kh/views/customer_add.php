...
<table width="100%" border="0">
  <tr>
    ...
    <td width="81%"><input type="text" name="c_name_en" class="txtbox"></td>
    <td width="81%">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="c_home" type="text" class="txtbox" size="5" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <th align="right" scope="row">ផ្លូវ</th>
    <td><input name="c_road" type="text" class="txtbox" size="5" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <th align="right" scope="row">សង្កាត់</th>
    <td><input type="text" name="c_sangkat" class="txtbox" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <th align="right" scope="row">ខណ្ឌ</th>
    <td><input type="text" name="c_khan" class="txtbox" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <th align="right" scope="row">ក្រុង</th>
    <td><input type="text" name="c_city" class="txtbox" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <th align="right" scope="row"><strong>លេខទូរស៍ព្ទ</strong></th>
    <td><input type="text" name="c_phone" class="txtbox" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>
		...
		<?php	
        	...
        	<tr>
            	<td><input type="checkbox" value="<?php echo $data['p_id'];?>" name="checked_news[]"><?php echo $data['p_name'];?>
                </td>
                <td><input name="qty[]" type="text" class="txtbox" size="3">ច្បាប់<br/>
                </td>
            </tr>
            <?php }?>
        </table>
